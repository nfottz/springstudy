...
<body>
	...
	<!-- 1. <a> -->
	<div>
		<a href="${contextPath }/detail.do?boardNo=1&title=제목">a링크로보내기</a>
		<a href="${contextPath }/detail.do">a링크로보내기(파라미터없음)</a>
	</div>
	...
	<div>
		<form method="post" action="${contextPath }/detail.do">
			...
			<button>form태그로보내기</button>
		</form>
			<form method="post" action="${contextPath }/detail.do">
			<button>form태그로보내기(파라미터없음)</button>
		</form>
	</div>
	
	<!-- 3. location -->
	<div>
		<button onclick="fnMove()">location으로보내기</button>
	<script>
		function fnMove(){
