	...
	*/
	...
	public Advisor advisor() {
		...
		*/
		...
		// BoardServiceImpl 클래스에 있는 메소드 중에서 이름이 Tx로 끝나는 메소드
		pointCut.setExpression("execution(* com.gdu.app06.service.BoardServiceImpl.*Tx(..))");
		
		// pointCut으로 등록된 메소드에 transactionInterceptor()를 동작시킨다.
