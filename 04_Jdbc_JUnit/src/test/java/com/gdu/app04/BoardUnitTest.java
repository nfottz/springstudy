...
/*
	...
	2. Bean 등록 방식
		...
		1) root-context.xml에 <bean> 태그를 작성한 경우
			@ContextConfiguration(locations={"file:src/main/webapp/WEB-INF/spring/root-context.xml"})	여러 경로 참조 가능(배열)
...
public class BoardUnitTest {
	...
	// BoardUnitTest 클래스를 실행할 때 org.slf4j.Logger(import 주의!)를 동작시킨다.
	...
	public void a5목록테스트() {
		...
		// System.out.println("a5 - " + list);	// log 기능으로 대체 예정
